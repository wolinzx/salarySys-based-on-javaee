...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="/MyDemo/css/admin/searchstaff.css">
	<link rel="stylesheet" type="text/css" href="css/admin/iconfont.css"/>
	<script src="/MyDemo/js/searchstaff.js"></script>
  ...
  <body>
    <div id="main">
			...
			<div id="main-content">
				<i class="iconfont icon-sousuo" id="indexicon"><span>此页面显示员工信息</span></i>
			</div>
